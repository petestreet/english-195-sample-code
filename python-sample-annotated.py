...
# This is where we run into our first issue.  While the code below tries to find out how many days old the user
# is by multiplying the age they provided by 365 (for 365 days in a year), all that gets output is their age
...
# of loop is a "for-loop", and those are the kind that we use in this program.  The idea is that a computer can do 
...
for i in range(10):
    # What's the problem with the output of this for-loop?  How might you fix it?
    print(i)
